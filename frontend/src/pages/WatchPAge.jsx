...
import { formatReleaseDate } from "../utils/dateFunctin";
...
const WatchPage = () => {
  ...
  const scrolLeft = () => {
    if (castSliderRef.current) {
      castSliderRef.current.scrollBy({
        left: -castSliderRef.current.offsetWidth,
        behavior: "smooth",
      });
    }
  };
  ...
  return (
    <div className="bg-black min-h-screen text-white">
      <div className=" mx-auto container px-4 py-8 h-full">
        ...
        <div className="aspect-video mb-8 p-3 sm:px-10 md:px-32">
          {trailers.length > 0 && (
            <ReactPlayer
              controls={true}
              width={"100%"}
          ...
          <div className="mt-12 max-w-5xl mx-auto relative">
            ...
            >
              {cast.map((member) => {
                ...
                return (
                  <div key={member.id} className="w-32 flex-none text-center">
                    <img
                      src={`${SMALL_IMG_BASE_URL}${member.profile_path}`}
                      alt="cast image"
